        ...
        <div className="navbar bg-white dark:bg-gray-900 shadow-sm flex justify-between px-5">
          ...
          <div className="flex w-[50%]">
            <ul className="w-full flex flex-row justify-evenly items-center">
              ...
              <li className={`text-gray-900 dark:text-gray-100 hover:text-rose-600 dark:hover:text-rose-500 cursor-pointer ${window.location.pathname === '/kids/1' ? 'text-rose-600 dark:text-rose-500' : ''}`}>
