    ...
    return(
        <div className="mainContainer dark:bg-gray-900 bg-gray-100 w-full md:p-10 p-5">
            ...
            <div className="images w-[90%] mx-auto items-end justify-center mt-16 flex md:gap-4 gap-1">
                ...
                <img className="rounded-full md:w-[18%] w-[36%] md:h-[500px] h-[300px] object-cover dark:opacity-85" src="https://images.pexels.com/photos/2787341/pexels-photo-2787341.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="" />
                <img className="rounded-full md:w-[20%] w-[36%] md:h-[600px] h-[300px] object-cover dark:opacity-85" src="https://images.pexels.com/photos/1183266/pexels-photo-1183266.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="" />
                <img className="rounded-full md:w-[18%] w-[36%] md:h-[500px] h-[300px] object-cover dark:opacity-85" src="https://images.pexels.com/photos/1340967/pexels-photo-1340967.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="" />
            </div>
        </div>
    )
}